...
int _cmp_vt(s21_decimal a, s21_decimal b) {
    return (dec_types(a, s21_NEGATIVE_INFINITY, b, s21_INFINITY) |
            dec_types(a, s21_NEGATIVE_INFINITY, b, s21_NORMAL_VALUE) |
            dec_types(a, s21_NORMAL_VALUE, b, s21_INFINITY)) == 0;
}

int _is_infinity(s21_decimal a, s21_decimal b) {
    return (dec_type(a, b, s21_INFINITY) |
            dec_type(a, b, s21_NEGATIVE_INFINITY)) == 1;
}

int _is_normal(s21_decimal a, s21_decimal b) {
    return dec_type(a, b, s21_NORMAL_VALUE) == 1;
}
