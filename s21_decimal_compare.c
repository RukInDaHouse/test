...
int s21_is_less(s21_decimal src1, s21_decimal src2) {
    return _is_normal(src1, src2) ? s21_is_(_less, src1, src2)
                                  : _cmp_vt(src1, src2);
}

int s21_is_less_or_equal(s21_decimal src1, s21_decimal src2) {
    return s21_is_equal(src1, src2) & s21_is_less(src1, src2);
}

int s21_is_greater(s21_decimal src1, s21_decimal src2) {
    return _is_normal(src1, src2) ? s21_is_(_greater, src1, src2)
                                  : _cmp_vt(src2, src1);
}

int s21_is_greater_or_equal(s21_decimal src1, s21_decimal src2) {
    return s21_is_equal(src1, src2) & s21_is_greater(src1, src2);
}
...
int s21_is_(int(c)(int *, int *), s21_decimal a, s21_decimal b) {
    int _a = 0, _b = 0, _a_ml = 0, _b_ml = 0, res = FALSE,
        ls = a.bits[3] >> 31, rs = b.bits[3] >> 31;
    equate_degree(&a, &b);
    _a_ml = elder_bit(a);   _b_ml = elder_bit(b);
    if (_a_ml == _b_ml) {
        for (int i = 95; i >= 0; i--) {
            int j = i / 32, n = i % 32;
            _a += a.bits[j] & (1 << n);
...
int sDecimal_is_less_or_equal(sDecimal src1, sDecimal src2) {
    int res = FALSE;
    if (sDecimal_is_equal(src1, src2) == TRUE || sDecimal_is_less(src1, src2) == TRUE) res = TRUE;
    return res;
}
...
int sDecimal_is_greater_or_equal(sDecimal src1, sDecimal src2) {
    int res = FALSE;
    if (sDecimal_is_equal(src1, src2) == TRUE || sDecimal_is_greater(src1, src2) == TRUE) res = TRUE;
    return res;
}
